-- REB-62: include buyer-safe sub-industry in the public teaser payload.
-- This lets RV parks and campgrounds display their actual business type instead
-- of a broad parent industry such as Restaurant / Hospitality.
...
comment on function public.get_public_teaser(text) is
  'Intentional public SECURITY DEFINER RPC. Returns only owner-selected buyer-safe teaser fields, including broad industry and sub-industry labels.';
