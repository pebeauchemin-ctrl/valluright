        ...
        <div className="mx-auto max-w-7xl px-6 py-20">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Step
              ...
              desc="Six valuation methods, a Health Score out of 100, and a clear picture of what buyers will care about."
            />
            <Step
              n="3"
      ...
      <section id="features" className="border-t border-border/60">
        <div className="mx-auto max-w-7xl px-6 py-20">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Feature
              icon={<TrendingUp />}
              title="Six valuation methods"
              desc="SDE, EBITDA, revenue, DCF, asset-based, and comparable sales — combined into one defensible range."
            />
            <Feature
              icon={<ShieldCheck />}
              title="Buyer-safe teaser"
              desc="A clean confidential teaser page you control, line by line. Sensitive details stay behind NDA."
            />
            <Feature
              icon={<Users />}
            ...
            <Feature
              icon={<FileCheck />}
              title="Light data room"
              desc="Organize financials, tax returns, leases, and more — ready when a buyer asks."
            />
          </div>
        </div>
      </section>
...
function Plan({
  ...
  return (
    <div
      className={`rounded-xl border p-6 ${highlighted ? "border-accent bg-card shadow-lg ring-2 ring-accent/20" : "border-border bg-card"}`}
    >
      {highlighted && (
