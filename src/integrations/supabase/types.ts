...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      buyer_access_request_events: {
        Row: {
          ...
          business_id: string;
          created_at: string;
          from_status: Database["public"]["Enums"]["access_request_status"] | null;
          id: string;
          note: string | null;
          request_id: string;
      ...
      buyer_access_requests: {
        Row: {
          ...
          created_at: string;
          email: string;
          financing_status: Database["public"]["Enums"]["financing_status"] | null;
          id: string;
          message: string | null;
          name: string;
          phone: string | null;
    ...
    Enums: {
      access_request_status: "pending" | "approved" | "denied" | "more_info_requested" | "nda_sent";
      advisor_invite_status: "pending" | "accepted" | "declined" | "revoked";
      app_role: "owner" | "advisor" | "buyer" | "admin";
      buyer_type: "individual" | "strategic" | "financial" | "search_fund" | "other";
      data_room_category:
        | "financials"
        | "tax_returns"
        | "lease_real_estate"
...
export const Constants = {
  public: {
    Enums: {
      ...
      exit_timeline: ["lt_1y", "1_2y", "2_5y", "5_plus_y", "exploring"],
      financing_status: ["cash", "sba_pre_approved", "sba_unverified", "seller_financing", "other"],
    },
  },
} as const;
